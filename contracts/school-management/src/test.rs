...
use crate::{school_management::{SchoolManagement, SchoolManagementClient},storage::Class,};
...
fn test_register_student() {
    ...
    setup_result.client.register_student( &name, &class_name, &setup_result.student_wallet,);
